...
<head>
    ...
    <title>Muito brigado! | Gutter Think</title>
    <meta charset="utf-8">
...
<body class="layout-ebook ebook">
    ...
    <div id="primary-content">
        ...
        <header id="main-header">
            ...
            <!-- BEGIN LOGO -->
            <div id="logo-wrap">
                <a href="http://gutterthink.com/blog/" class="logo">
    ...
    <!-- BEGIN THIRD CONTENT -->
    <div class="thanks-padding">
        <section style="background-color: white;" id="form" class="form-default">
            <form action="ebook.pdf" method="get" class="container">
                <h2 style="color: black;">OBRIGADO!</h2>
                <br>
                <button class="call-action"><a style="text-decoration: none;" href="ebook.pdf" download>Quero o e-book gratuito!</a></button>
                <small>Esperamos que você aproveite seu novo ebook.</small>
            </form>
        </section>
        <!-- END THIRD CONTENT -->
    </div>
